...
.L14:
	...
	.align	1
	.globl	uart_mysendstring
	.type	uart_mysendstring, @function
uart_mysendstring:
	addi	sp,sp,-48
	sw	ra,44(sp)
	sw	s0,40(sp)
...
.L19:
	...
	addi	sp,sp,48
	jr	ra
	.size	uart_mysendstring, .-uart_mysendstring
	.align	1
	.globl	uart_getstring
	.type	uart_getstring, @function
uart_getstring:
	addi	sp,sp,-32
	sw	ra,28(sp)
	sw	s0,24(sp)
...
.L21:
	...
	addi	sp,sp,32
	jr	ra
	.size	uart_getstring, .-uart_getstring
